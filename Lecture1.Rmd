...
* A lower level control can be achieved by using the `theme(...)` [function]{https://ggplot2.tidyverse.org/reference/theme.html} 
...
* Focus on athletics
* Plot the average and max age of a gold medal winner over the years
