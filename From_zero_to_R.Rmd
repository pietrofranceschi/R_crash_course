...
# the second with the number of days, 
# the third with the (approximate) season
...
This famous (Fisher's or Anderson's) iris dataset gives the measurements in cm of the lenght and width of sepals and petals for 50 flowers from each of 3 species of iris. 
